...
<script>
	...
	$('[data-key="addthis_code"] input').change(function(){
		/* change:
			<!-- Go to www.addthis.com/dashboard to customize your tools --> <s cript type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-58a9c979c9b5300a"></s cript> 
		  into:
			https://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-58a9c979c9b5300a
		*/
		var $this = $(this);
		var val = $this.val();
		var rx = /src=".+addthis.com\/.+addthis_widget.js([^"]*)"/;
		if (val && rx.test(val)){
			var match = val.match(rx);
			update('addthis_code',match[1]);
			$this.val(match[1]);
		}
	});
